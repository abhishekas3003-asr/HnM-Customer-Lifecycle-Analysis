...
- **`/sql`** — queries organised by analysis stage (`00_data_prep` through `05_rfm_segmentation`), each with a header noting the question it answers.
- **`/dashboard`** — the 4-page Power BI file and page screenshots.
- **`/docs`** — data dictionary and full findings write-up.
